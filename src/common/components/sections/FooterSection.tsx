...
//             sm={12}
//             xs={12}
//             className={`${CLASS}__contact-column`}
//           >
//             <div className={`${CLASS}__contact-wrapper`}>
//               <h4 className={`${CLASS}__column-title`}>
...
//                     className={`${CLASS}__contact-link`}
//                   >
...
//                 <div className={`${CLASS}__contact-item`}>
//                   <a
//                     href={`tel:${footerData.contact.address}`}
//                     className={`${CLASS}__contact-link`}
//                   >
